...
public class Hook {
	...
	public void setUpAppium() throws MalformedURLException
	{
		if ( Hook.platform == TestPlatform.Android) {
			...
			cap.setCapability(MobileCapabilityType.PLATFORM_VERSION, "11"); //作業系統版本
			cap.setCapability(MobileCapabilityType.DEVICE_NAME, "emulator-5554"); //手機DeviceId
			cap.setCapability(MobileCapabilityType.APP, "C:\\Users\\EasonLu\\IdeaProjects\\BDDSample\\app-debug.apk"); //要測試的APK路徑
			driver = new AndroidDriver(new URL("http://localhost:4723/wd/hub"), cap); //AppiumDriver位址
